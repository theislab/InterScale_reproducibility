...
def parse_args():
	...
	parser.add_argument(
		"--config",
		type=str,
		default='config_files/melton_jimenez_25/InterScale_Cosmx_Nrec_Modular.yaml',
...
def main():
	...
	out_csv = output_dir / f"ID_{args.dataset_name}_metrics_seed_{args.seed}.csv"
